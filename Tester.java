...
testEquality(new ArrayList<Integer>(Arrays.asList(14,13,12,11,10)),
ListUtil.exclusiveSum(list1));
testEquality(new ArrayList<Integer>(Arrays.asList(31,28,26,25,22)), 
ListUtil.exclusiveSum(list2));
}
